...
'''
최적의 매개 변수 : RandomForestClassifier(max_depth=6, n_estimators=200)
...
최적의 매개 변수 : XGBClassifier(base_score=0.5, booster='gbtree', colsample_bylevel=1,
              ...
              min_samples_leaf=10, min_samples_split=3, missing=nan,
              monotone_constraints='()', n_estimators=100, n_jobs=12,
              num_parallel_tree=1, objective='multi:softprob', predictor='auto',
              random_state=0, reg_alpha=0, reg_lambda=1, scale_pos_weight=None,
              subsample=1, tree_method='exact', validate_parameters=1, ...)
최적의 파라미터 :  {'min_samples_split': 3, 'min_samples_leaf': 10}
best_score_ : 0.951231527093596
'''