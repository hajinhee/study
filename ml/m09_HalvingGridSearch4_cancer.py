...
#2. 모델 구성
model = HalvingGridSearchCV(XGBClassifier(), parameters, cv = kfold, verbose = 3,
                     refit=True, n_jobs=1)
...
best_score_ : 0.9582362082362083
소요 시간 : 17.89161705970764
...
최적의 매개 변수 : XGBClassifier(base_score=0.5, booster='gbtree', colsample_bylevel=1,
              ...
              min_samples_leaf=10, min_samples_split=5, missing=nan,
              monotone_constraints='()', n_estimators=100, n_jobs=12,
              num_parallel_tree=1, predictor='auto', random_state=0,
              reg_alpha=0, reg_lambda=1, scale_pos_weight=1, subsample=1,
              tree_method='exact', validate_parameters=1, verbosity=None)
최적의 파라미터 :  {'min_samples_leaf': 10, 'min_samples_split': 5}
best_score_ : 0.9675278425278425
소요 시간 : 7.397839784622192
'''