...
'''
최적의 매개 변수 : RandomForestRegressor(max_depth=12, min_samples_leaf=3, min_samples_split=3,
                      n_estimators=200)
최적의 파라미터 :  {'max_depth': 12, 'min_samples_leaf': 3, 'min_samples_split': 3, 'n_estimators': 200}
best_score_ : 0.35699683831384305
model.score : 0.3499395334408475
r2_score : 0.3499395334408475
'''